...
var db_file = "/home/pi/repo/BLE_Rpi_Peripheral/test.txt";

var db2 = fs.readFileSync(db_file).toString('base64');
...
var terminal = new bleno.Characteristic({
    ...
    onReadRequest : function(offset, callback) {
        ...
        console.log(offset);
//	var cutdistance = file.search('/n');
//	var cutfile = file.slice(0,cutdistance);
//	cutfile = cutfile.toString('base64');
//	file = file.slice(cutdistance);
	let buf = Buffer.from(db2);


//	let str = Buffer.from(buf).toString();

//	console.log(str);
	callback(bleno.Characteristic.RESULT_SUCCESS, db2.slice(offset));
	console.log('foi??');	
    },
